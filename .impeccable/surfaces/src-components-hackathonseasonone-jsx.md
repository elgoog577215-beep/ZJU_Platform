...
- Direction: use the About page's site-level dark glass and restrained cyan for the cross-event shell. The event context and four-stage control are a compact text navigation, not another row of feature cards; embedded project and media surfaces retain their incumbent backgrounds and visual identity.
