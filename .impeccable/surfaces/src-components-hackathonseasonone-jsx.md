...
- Global search: use one theme-aware translucent glass surface over an independent dimmed, blurred scrim; keep input, results, empty state and keyboard help readable without stacking decorative cards.
