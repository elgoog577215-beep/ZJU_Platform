...
- Direction: use the About page's site-level dark surface and restrained cyan for the cross-event shell. The event context, four-stage control, and desktop event index are compact typographic navigation rather than cards or glowing timelines; embedded project and media surfaces retain their incumbent backgrounds and visual identity.
