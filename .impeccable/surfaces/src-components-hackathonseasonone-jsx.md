...
- Direction: use the About page's site-level dark glass, cyan grid, crisp rectangular panels and restrained glow for the cross-event shell. Keep generous separation before the content body; embedded project and media surfaces retain their incumbent backgrounds and visual identity.
