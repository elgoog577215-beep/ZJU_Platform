    ...
    useEffect(() => {
        ...
        if (navigation) {
            const ttfb = {
                ...
                rating:
                    navigation.responseStart - navigation.startTime < 600
                        ? "good"
                        : "needs-improvement",
            };
        ...
        <div className="fixed bottom-4 left-4 z-50 bg-black/80 backdrop-blur-md text-white text-xs p-4 rounded-lg font-mono">
            ...
            {vitals.lcp && (
                <div className="flex justify-between gap-4">
                    ...
                    <span
                        className={
                            vitals.lcp.rating === "good" ? "text-green-400" : "text-yellow-400"
                        }
                    >
            ...
            {vitals.fid && (
                <div className="flex justify-between gap-4">
                    ...
                    <span
                        className={
                            vitals.fid.rating === "good" ? "text-green-400" : "text-yellow-400"
                        }
                    >
            ...
            {vitals.cls && (
                <div className="flex justify-between gap-4">
                    ...
                    <span
                        className={
                            vitals.cls.rating === "good" ? "text-green-400" : "text-yellow-400"
                        }
                    >
            ...
            {memory && (
                <div className="mt-2 pt-2 border-t border-white/20">
                    <div className="flex justify-between gap-4">
                        ...
                        <span
                            className={
                                parseFloat(memory.usagePercent) > 80
                                    ? "text-red-400"
                                    : "text-green-400"
                            }
                        >
