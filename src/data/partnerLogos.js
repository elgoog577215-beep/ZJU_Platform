...
export const defaultEcosystemPartners = [
    ...
    {
        id: "default-enterprise-huawei",
        profile_handle: "partner-huawei",
        category: "enterprise",
        name: "华为",
        name_en: "Huawei",
        description: "提供数智化技术体系与产业实践支持。",
        description_en: "Provides digital intelligence capabilities and industry practice support.",
        logo_url: "/images/partner-logos/huawei.png",
        dark_logo_url: "/images/partner-logos/huawei.png",
        size: "h-5 sm:h-6 lg:h-7",
        sort_order: 70,
        enabled: true,
        featured: true,
    ...
    {
        id: "default-enterprise-qwen",
        profile_handle: "partner-qwen",
        category: "enterprise",
        name: "通义千问",
        name_en: "Qwen",
        description: "提供模型能力与 AI 应用实践支持。",
        description_en: "Provides model capabilities and AI application practice support.",
        logo_url: "/images/partner-logos/qwen-official.png",
        dark_logo_url: "/images/partner-logos/qwen-official-dark.png",
        size: "h-6 sm:h-7 lg:h-8",
        sort_order: 80,
        enabled: true,
        featured: true,
    },
    {
        ...
        logo_url: "/images/partner-logos/chuangfeifan.svg",
...
export const normalizeEcosystemPartner = (partner = {}) => {
    ...
    return {
        ...
        cooperation_direction: partner.cooperation_direction || partner.cooperationDirection || "",
...
export const getPartnerProfilePath = (partner = {}) => {
    ...
    const fallbackHandle = /^\d+$/.test(String(partner.id || "")) ? `partner-${partner.id}` : "";
