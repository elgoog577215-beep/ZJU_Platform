...
export const normalizeEventCategoryValue = (value) => {
    ...
    const aliasMatch = Object.entries(EVENT_CATEGORY_ALIASES).find(([, aliases]) =>
...
export const EVENT_AUDIENCE_GROUPS = [
    ...
    {
        group: "中外合作办学",
        items: ["浙江大学伊利诺伊大学厄巴纳香槟校区联合学院", "浙江大学爱丁堡大学联合学院"],
    },
];

export const EVENT_AUDIENCE_OPTIONS = EVENT_AUDIENCE_GROUPS.flatMap(({ items }) => items);
