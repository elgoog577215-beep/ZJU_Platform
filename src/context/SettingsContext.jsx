...
import { DEFAULT_BACKGROUND_SCENE, isBackgroundSceneId } from "../constants/backgroundScenes";
...
const DEFAULT_SETTINGS = {
    ...
    about_detail:
        "在这里，你可以浏览活动集合、加入 AI 社区、参与项目与浙客松，并把过程、作品和关系沉淀为下一次合作的基础。",
...
const LEGACY_SETTING_VALUES = {
    ...
    about_intro: [
        "我们致力于打破信息差，提供一个高质量的信息共享平台。",
        "我们致力于打破信息差，提供一个优质信息共享平台。",
    ],
    about_detail: [
