...
import { Box, Upload, AlertCircle, Maximize2, X } from "lucide-react";
...
const PhotoCard = memo(
    forwardRef(({ photo, index, onClick, onToggleFavorite, canAnimate, isDayMode, t }, ref) => {
...
const Gallery = () => {
    ...
    useEffect(() => {
        ...
        api.get(`/photos/${id}`, { signal: abortController.signal })
            .then((res) => {
            ...
            {createPortal(
                isMobileSortOpen ? (
                    <>
                        ...
                        >
                            <div
                                className={`p-4 border-b flex justify-between items-center sticky top-0 z-10 ${isDayMode ? "border-slate-200/70 bg-white" : "border-white/10 bg-[#1a1a1a]"}`}
                            >
                                <div>
                                    <h3
