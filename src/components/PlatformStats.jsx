    ...
    return (
        <div className="relative mx-auto aspect-square w-full max-w-[500px] overflow-hidden">
            <motion.div
                ...
                transition={
                    shouldAnimate ? { duration: 32, ease: "linear", repeat: Infinity } : undefined
                }
            ...
            <motion.div
                animate={shouldAnimate ? { rotate: -360 } : undefined}
                transition={
                    shouldAnimate ? { duration: 46, ease: "linear", repeat: Infinity } : undefined
                }
            ...
            <motion.div
                animate={
                    shouldAnimate ? { scale: [1, 1.035, 1], opacity: [0.92, 1, 0.92] } : undefined
                }
                transition={
                    shouldAnimate
            ...
            >
                <Orbit className={`h-8 w-8 ${isDayMode ? "text-cyan-600" : "text-cyan-200"}`} />
    ...
    return (
        <div className="relative mx-auto aspect-[1.45] w-full max-w-[920px] overflow-hidden px-3 py-6 sm:px-8 sm:py-10 lg:aspect-[1.34] lg:px-10 lg:py-12">
            ...
            <motion.div
                animate={shouldAnimate ? { rotate: 360 } : undefined}
                transition={
                    shouldAnimate ? { duration: 58, ease: "linear", repeat: Infinity } : undefined
                }
            ...
            <motion.div
                animate={
                    shouldAnimate ? { scale: [1, 1.06, 1], opacity: [0.58, 0.86, 0.58] } : undefined
                }
                transition={
                    shouldAnimate
                ...
                return (
                    ...
                    >
                        <div className="flex items-center justify-between gap-3">
                            <div
                                className={`font-mono text-[10px] font-black uppercase tracking-[0.2em] ${item.accent}`}
                            >
                                {item.index} / {item.code}
                            </div>
                            <div
                                className={`flex h-8 w-8 items-center justify-center ${item.iconBg} text-slate-950 shadow-[0_0_30px_rgba(103,232,249,0.18)]`}
                            >
                        ...
                        <div
                            className={`mt-4 flex items-center justify-between border-t pt-3 text-sm font-black ${paletteSafeDivider(isDayMode)} ${item.accent}`}
                        >
                            <span>{item.loop}</span>
...
const paletteSafeDivider = (isDayMode) => (isDayMode ? "border-slate-200/80" : "border-white/10");

const homeSnapSections = [
    { id: "home-hero", labelKey: "home.platform.nav_home", fallback: "Home", icon: Zap },
    {
        id: "home-ecosystem",
        labelKey: "home.platform.nav_ecosystem",
        fallback: "Ecosystem",
        icon: Network,
    },
    ...
    {
        id: "home-resources",
        labelKey: "home.platform.nav_resources",
        fallback: "Resources",
        icon: Handshake,
    },
...
const PlatformStats = ({ hero } = {}) => {
    ...
    const proofStats = [
        {
            ...
            label:
                ...
                t("home.platform.stat_user_base", "Platform User Base"),
            hint: t(
                "home.platform.stat_user_base_hint",
                "Supports event reach, community connections, and project conversion"
            ),
        },
        {
            value: "4",
            ...
            hint: t(
                "home.platform.stat_service_chain_hint",
                "Information publishing, community collaboration, scenario access, and practice validation"
            ),
        },
        {
            ...
            label:
                ...
                t("home.platform.stat_sprint_label", "Timed Practice Mechanism"),
            hint: t(
                "home.platform.stat_sprint_hint",
                "Helps topics become prototype outcomes quickly"
            ),
        },
    ];
    ...
    const operatingHandles = [
        {
            ...
            icon: CalendarDays,
            description: t(
                "home.platform.handle_events_desc",
                "Publish campus AI events, enterprise topics, project calls, and learning resources from one entry point."
            ),
            route: "/events",
        ...
        },
        {
            ...
            icon: Users,
            description: t(
                "home.platform.handle_community_desc",
                "Connect learners, developers, student organizations, and project leads for ongoing exchange and collaboration."
            ),
            route: "/community",
        ...
        },
        {
            ...
            icon: Trophy,
            description: t(
                "home.platform.handle_hackathon_desc",
                "Run timed builds and reviews around enterprise topics to validate AI-native development capability."
            ),
            route: "/hackathon",
    ...
    const palette = isDayMode
        ? {
              ...
              panel: "border-slate-200 bg-white/88 shadow-[0_28px_90px_rgba(15,23,42,0.12)]",
              panelStrong:
                  "border-cyan-500/20 bg-white/92 shadow-[0_36px_110px_rgba(15,23,42,0.14)]",
              card: "border-slate-200 bg-white/88 shadow-[0_24px_70px_rgba(15,23,42,0.1)]",
        ...
        : {
              ...
              panel: "border-white/10 bg-[#101516]/88 shadow-[0_28px_90px_rgba(0,0,0,0.46)]",
              panelStrong:
        ...
        >
            ...
            >
                ...
                >
                    <div className={palette.firstText}>
                        ...
                        <h2 className="mt-6 max-w-[min(100%,48rem)] text-[2.15rem] font-black leading-[0.96] tracking-tight text-balance min-[360px]:text-[2.45rem] sm:text-5xl lg:text-[clamp(3.25rem,3.75vw,4.45rem)] lg:leading-[0.96] 2xl:text-[4.9rem]">
                            <span className="block">
                                {t("home.platform.ecosystem_title_1", "Connect real")}
                            </span>
                            <span className={`block ${palette.accent}`}>
                                {t("home.platform.ecosystem_title_2", "enterprise briefs")}
                            </span>
                            <span className="block">
                                {t("home.platform.ecosystem_title_3", "to a campus AI network.")}
                            </span>
                        </h2>
                        ...
                        >
                            {t(
                                "home.platform.ecosystem_desc",
                                "The platform connects students, campus support units, and enterprise partners around AI events, community co-creation, real briefs, and practice competitions."
                            )}
                        </p>

                        <div className="mt-5 grid grid-cols-2 gap-2 sm:mt-6 sm:flex sm:flex-row sm:gap-3">
                            <LinkButton isDayMode={isDayMode} onClick={() => navigate("/events")}>
                        ...
                        <div
                            className={`mt-4 grid grid-cols-3 gap-px border ${palette.grid} sm:mt-8`}
                        >
                            {proofStats.map((item) => (
                                <div
                                    key={item.label}
                                    className={`min-h-[76px] p-3 sm:min-h-0 sm:p-5 ${palette.cell}`}
                                >
                                    <div
                                        className={`text-2xl font-black leading-none tracking-tight min-[360px]:text-3xl sm:text-[2rem] ${palette.accent}`}
                                    >
                                        {item.value}
                                    </div>
                                    ...
                                    <p
                                        className={`mt-2 hidden text-xs leading-5 sm:block ${palette.textMuted}`}
                                    >
                                        {item.hint}
                                    </p>
                                </div>
                        ...
                        <div
                            className={`mt-4 grid gap-px overflow-hidden border md:hidden ${
                                isDayMode
                        ...
                        >
                            {operatingHandles.slice(0, 3).map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span
                                            className={`flex h-8 w-8 items-center justify-center ${item.iconBg} text-slate-950 shadow-[0_0_24px_rgba(103,232,249,0.18)]`}
                                        >
                                            <Icon className="h-4 w-4" />
                                        </span>
                                        <span className="min-w-0">
                                            <span
                                                className={`block font-mono text-[10px] font-black uppercase tracking-[0.18em] ${item.accent}`}
                                            >
                                                {item.code}
                                            </span>
                                        ...
                                        <ArrowRight
                                            className={`h-4 w-4 transition group-hover:translate-x-0.5 ${palette.textMuted}`}
                                        />
                                    </button>
                                );
                            })}
                    ...
                    <div
                        className={`relative hidden min-h-[430px] border p-4 sm:p-6 md:block lg:flex lg:min-h-[560px] lg:items-center ${palette.panelStrong}`}
                    >
            ...
            >
                ...
                >
                    <div className="relative">
                        <div
                            className={`pointer-events-none absolute -left-4 -top-20 hidden text-[12vw] font-black uppercase leading-none tracking-tight lg:block ${palette.watermark}`}
                        >
                            PATH
                        </div>
                        <p
                            className={`text-xs font-black uppercase tracking-[0.24em] ${palette.label}`}
                        >
                        ...
                        <h2 className="relative mt-3 max-w-[min(100%,37rem)] text-[1.9rem] font-black leading-none tracking-tight text-balance sm:text-5xl lg:text-[clamp(2.45rem,2.85vw,3.55rem)]">
                            <span className="block">
                                {t("home.platform.engine_title_1", "Not just more events.")}
                            </span>
                            <span className="block">
                                {t("home.platform.engine_title_2", "A clearer path.")}
                            </span>
                        </h2>
                        <p
                            className={`relative mt-5 max-w-2xl text-sm font-bold leading-7 sm:text-base sm:leading-8 ${palette.textSoft}`}
                        >
                            {t(
                                "home.platform.engine_desc",
                                "The homepage keeps four actionable entries: discover first, connect next, enter real scenarios, then validate outcomes through timed practice."
                            )}
                        </p>

                        <div
                            className={`relative mt-7 overflow-hidden border px-4 py-5 md:hidden ${palette.panelStrong}`}
                        >
                            <div
                                className={`pointer-events-none absolute left-7 top-8 bottom-8 w-px ${isDayMode ? "bg-cyan-500/24" : "bg-cyan-300/28"}`}
                            />
                            <div className="relative z-10 grid gap-4">
                                {operatingHandles.map((item) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <span
                                                className={`relative flex h-9 w-9 items-center justify-center ${item.iconBg} text-slate-950 shadow-[0_0_26px_rgba(103,232,249,0.2)]`}
                                            >
                                                <Icon className="h-4 w-4" />
                                            </span>
                                            <span>
                                            ...
                                            <ArrowRight
                                                className={`h-4 w-4 transition group-hover:translate-x-1 ${item.accent}`}
                                            />
                                        </button>
                                    );
                                })}
                        ...
                        <div
                            className={`relative mt-8 hidden max-w-2xl grid-cols-4 gap-5 border-t pt-5 sm:grid lg:grid-cols-2 ${palette.divider}`}
                        >
                            {operatingHandles.map((item) => (
                                <button
                                    key={item.code}
                                ...
                                >
                                    <div
                                        className={`font-mono text-[10px] font-black uppercase tracking-[0.18em] ${item.accent}`}
                                    >
                                        {item.index} / {item.code}
                                    </div>
                    ...
                    <div
                        className={`relative hidden overflow-hidden md:block lg:min-h-[600px] ${isDayMode ? "bg-white/58 shadow-[0_34px_110px_rgba(15,23,42,0.1)]" : "bg-white/[0.025] shadow-[0_36px_120px_rgba(0,0,0,0.32)]"}`}
                    >
                        ...
                        <div
                            className={`pointer-events-none absolute right-4 top-2 text-[18vw] font-black uppercase leading-none tracking-tight lg:text-[9rem] ${palette.watermark}`}
                        >
                            LOOP
                        </div>
                        <EnginePathVisual
            ...
            >
                ...
                >
                    <div
                        className={`relative overflow-hidden p-4 sm:p-7 lg:min-h-[620px] lg:p-10 ${isDayMode ? "bg-white/64 shadow-[0_34px_110px_rgba(15,23,42,0.1)]" : "bg-white/[0.025] shadow-[0_36px_120px_rgba(0,0,0,0.3)]"}`}
                    >
                        ...
                        <div
                            className={`pointer-events-none absolute left-0 top-0 h-full w-1 ${palette.accentBg}`}
                        />
                        <div className="relative z-10 flex h-full flex-col justify-between gap-7 lg:min-h-[540px]">
                            <div>
                                <div
                                    className={`font-mono text-xs font-black uppercase tracking-[0.2em] ${palette.accent}`}
                                >
                                    01 / Foundation
                                </div>
                                ...
                                <p
                                    className={`mt-3 max-w-lg text-xs leading-5 sm:mt-5 sm:text-[0.95rem] sm:leading-7 ${palette.textSoft}`}
                                >
                                    {t(
                                        "home.platform.resources_desc",
                                        "Campus support units provide scenarios, spaces, and organization. Student groups drive reach and execution. Enterprise partners bring real briefs, technology, and outcome pathways."
                                    )}
                                </p>
                            </div>
                            ...
                            <div className="relative hidden min-h-[170px] md:block">
                                <div
                                    className={`absolute left-1/2 top-1/2 h-px w-[78%] -translate-x-1/2 ${isDayMode ? "bg-cyan-500/26" : "bg-cyan-300/28"}`}
                                />
                                <div
                                    className={`absolute left-1/2 top-1/2 h-[76%] w-px -translate-y-1/2 ${isDayMode ? "bg-cyan-500/18" : "bg-cyan-300/22"}`}
                                />
                                {[
                                    {
                                        label: t("home.platform.node_school", "Campus Scenarios"),
                                        className: "left-0 top-0",
                                    },
                                    {
                                        label: t("home.platform.node_students", "Student Groups"),
                                        className: "right-0 top-1/2 -translate-y-1/2",
                                    },
                                    {
                                        label: t(
                                            "home.platform.node_enterprise",
                                            "Enterprise Briefs"
                                        ),
                                        className: "left-[18%] bottom-0",
                                    },
                                ].map((node) => (
                                    <div
                                        key={node.label}
                                ...
                                <div
                                    className={`absolute left-1/2 top-1/2 flex h-24 w-24 -translate-x-1/2 -translate-y-1/2 items-center justify-center border text-center text-xs font-black uppercase tracking-[0.16em] ${
                                        isDayMode
                            ...
                            <div className="grid grid-cols-2 gap-2 sm:grid-cols-1 sm:gap-3">
                                {schoolSupport.map((partner) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div
                                                className={`flex items-center gap-1.5 text-[7px] font-black uppercase tracking-[0.1em] sm:gap-2 sm:text-[11px] sm:tracking-[0.18em] ${palette.textMuted}`}
                                            >
                                                <Building2 className="h-3.5 w-3.5" />
                                                School Support
                                            </div>
                                            <div className="text-left text-sm font-black leading-tight sm:text-xl">
                                                {name}
                                            </div>
                                        </button>
                                    );
                    ...
                    <div className="grid gap-7 lg:min-h-[620px] lg:grid-rows-[minmax(0,0.78fr)_minmax(0,1.22fr)]">
                        <div
                            className={`relative overflow-hidden border-t px-0 py-2 sm:py-0 lg:flex lg:items-center ${palette.divider}`}
                        >
                            <div className="grid w-full gap-6 lg:grid-cols-[minmax(0,0.36fr)_minmax(0,0.64fr)] lg:items-center">
                                <div>
                                    <div
                                        className={`flex items-center gap-2 font-mono text-xs font-black uppercase tracking-[0.2em] ${palette.accent}`}
                                    >
                                    ...
                                    <h3 className="mt-2 text-2xl font-black tracking-tight sm:mt-3 sm:text-[2.35rem] lg:text-[clamp(2.3rem,3vw,3.25rem)]">
                                        {t(
                                            "home.platform.student_orgs_title",
                                            "Student Organizations"
                                        )}
                                    </h3>
                                    <p
                                        className={`mt-2 hidden max-w-md text-sm font-bold leading-6 sm:block ${palette.textMuted}`}
                                    >
                                        {t(
                                            "home.platform.student_orgs_desc",
                                            "Responsible for reach, operations, collaboration, and review so AI practice communities keep gathering."
                                        )}
                                    </p>
                                </div>
                        ...
                        <div
                            className={`relative overflow-hidden p-4 sm:p-7 lg:p-8 ${isDayMode ? "bg-white/58 shadow-[0_26px_80px_rgba(15,23,42,0.1)]" : "bg-white/[0.025] shadow-[0_30px_100px_rgba(0,0,0,0.28)]"}`}
                        >
                            ...
                            <div className="relative z-10 grid gap-6 lg:grid-cols-[minmax(0,0.34fr)_minmax(0,0.66fr)]">
                                <div className="flex flex-col justify-between gap-5">
                                    <div>
                                        ...
                                        <h3 className="mt-2 text-2xl font-black tracking-tight sm:mt-3 sm:text-[2.35rem] lg:text-[clamp(2.3rem,3vw,3.25rem)]">
                                            {t(
                                                "home.platform.enterprise_title",
                                                "Enterprise Partners"
                                            )}
                                        </h3>
                                        <p
                                        ...
                                        >
                                            {t(
                                                "home.platform.enterprise_desc",
                                                "Provide real briefs, model capabilities, cloud resources, and outcome evaluation so prototypes can be tested."
                                            )}
                                        </p>
                                    </div>
                                    <div
                                        className={`hidden border-l-4 px-4 py-3 text-sm font-black leading-6 lg:block ${isDayMode ? "border-l-cyan-500 bg-white/70 text-slate-600" : "border-l-cyan-300 bg-cyan-300/[0.05] text-white/64"}`}
                                    >
                                        {t(
                                            "home.platform.resource_chain",
                                            "Resources are not a sponsor wall; they form a scenario - people - technology - competition conversion chain."
                                        )}
                                    </div>
                                </div>
                                            ...
                                            {getPartnerLogoSrc(logo, isDayMode) ? (
                                                <img
                                                    ...
                                                    className={`w-auto max-w-full object-contain transition duration-300 group-hover:scale-[1.04] ${
                                                        logo.size ||
                                                        "h-5 sm:h-7 lg:h-[clamp(1.35rem,2.7vh,1.9rem)]"
            ...
            >
                ...
                >
                    <div className="relative">
                        ...
                        <div className="relative">
                            <p
                                className={`flex items-center gap-2 text-xs font-black uppercase tracking-[0.24em] ${palette.label}`}
                            >
                            ...
                            <p
                                className={`mt-5 max-w-xl text-sm font-bold leading-7 sm:text-base sm:leading-8 ${palette.textSoft}`}
                            >
                                {t(
                                    "home.platform.live_desc",
                                    "The last homepage section returns from platform narrative to real content users can click, join, and follow."
                                )}
                            </p>
                        </div>
                        <div className="relative mt-6 flex flex-col gap-3 sm:flex-row lg:flex-col lg:items-start">
                            <LinkButton isDayMode={isDayMode} onClick={() => navigate("/articles")}>
                        ...
                        <div
                            className={`relative mt-6 hidden max-w-xl grid-cols-3 gap-px border sm:grid ${palette.grid}`}
                        >
                            {[
                                {
                                    label: t("home.platform.metric_content", "Content"),
                                    value: featuredPreviewItems.length || 0,
                                },
                                {
                                    label: t("home.platform.metric_entries", "Entries"),
                                    value: "3+",
                                },
                                {
                                    label: t("home.platform.metric_following", "Following"),
                                    value: user ? followingFeed.length : t("auth.log_in", "Log In"),
                                },
                            ].map((item) => (
                                <div key={item.label} className={`p-3 sm:p-4 ${palette.cell}`}>
                                    <div
                                        className={`text-2xl font-black leading-none ${palette.accent}`}
                                    >
                                        {item.value}
                                    </div>
                                    <div
                                        className={`mt-2 text-[11px] font-black uppercase tracking-[0.16em] ${palette.textMuted}`}
                                    >
                                        {item.label}
                                    </div>
                                </div>
                    ...
                    <div className="grid gap-4 lg:min-h-[620px] lg:grid-rows-[minmax(0,1fr)_auto]">
                        <div>
                            {featuredLoading && featuredPreviewItems.length === 0 ? (
                                ...
                                <div className={`border px-5 py-6 text-sm ${palette.card}`}>
                                    <div>
                                        {t(
                                            "home.platform.featured_load_failed",
                                            "Featured content failed to load"
                                        )}
                                    </div>
                                    <button
                                        type="button"
                                    ...
                                    {featuredPreviewItems.map((item, index) => {
                                        ...
                                        return (
                                            <motion.button
                                                variants={listItem}
                                                whileTap={
                                                    prefersReducedMotion ? undefined : tapPress
                                                }
                                            ...
                                            >
                                                <div
                                                    className={`${index === 0 ? "h-32 lg:h-[360px]" : "h-32 lg:h-[210px]"} ${isDayMode ? "bg-slate-100" : "bg-black/40"}`}
                                                >
                                                    {item.image ? (
                                                        <img
                                                            src={item.image}
                                                ...
                                                <div className="p-4 lg:p-6">
                                                    <div
                                                        className={`mb-3 inline-flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.16em] ${palette.textMuted}`}
                                                    >
                                                        <Icon size={13} />
                                                        {item.subtitle}
                                                    </div>
                                                    <div
                                                        className={`line-clamp-2 text-xl font-black leading-7 ${index === 0 ? "lg:text-[2.1rem] lg:leading-tight" : ""} ${isDayMode ? "text-slate-950" : "text-white"}`}
                                                    >
                                                        {item.title}
                                                    </div>
                                                    <div
                        ...
                        {user && (
                            ...
                            >
                                <div>
                                    <div className="mb-4 flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-2">
                                            <div
                                                className={`flex h-9 w-9 items-center justify-center ${isDayMode ? "bg-indigo-50 text-indigo-500" : "bg-indigo-400/10 text-indigo-300"}`}
                                            >
                                                <Users size={16} />
                                            </div>
                                            <span
                                                className={`text-xs font-black uppercase tracking-[0.18em] ${palette.textMuted}`}
                                            >
                                                {t(
                                                    "home.platform.following_feed",
                                                    "Following Feed"
                                                )}
                                            </span>
                                        </div>
                                    ...
                                    {followLoading ? (
                                        ...
                                        <div
                                            className={`border px-4 py-5 text-sm ${isDayMode ? "border-slate-200/80 bg-slate-50/80 text-slate-500" : "border-white/10 bg-black/20 text-gray-400"}`}
                                        >
                                            {t(
                                                "home.platform.following_empty",
                                                "Authors you follow have not posted new content yet"
                                            )}
                                        </div>
                                    ) : (
                                        <motion.div
                                            ...
                                            initial={prefersReducedMotion ? false : "initial"}
                                            whileInView={
                                                prefersReducedMotion ? undefined : "animate"
                                            }
                                            viewport={motionTokens.viewport}
                                        ...
                                        >
                                            {followingFeed.map((item) => (
                                                ...
                                                >
                                                    <div
                                                        className={`truncate text-base font-black ${isDayMode ? "text-slate-950" : "text-white"}`}
                                                    >
                                                        {item.title}
                                                    </div>
                                                    <div
                                                        className={`mt-2 text-xs leading-5 ${palette.textMuted}`}
                                                    >
                                ...
                                <div
                                    className={`border p-4 ${isDayMode ? "border-slate-200 bg-white/72" : "border-white/10 bg-black/20"}`}
                                >
                                    <div
                                        className={`mb-3 text-xs font-black uppercase tracking-[0.18em] ${palette.textMuted}`}
                                    >
                                        {t(
                                            "home.platform.recommended_follows",
                                            "Recommended Follows"
                                        )}
                                    </div>
                                    <div className="space-y-2">
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {followed
                                                            ? t(
                                                                  "home.platform.followed",
                                                                  "Following"
                                                              )
                                                            : t("home.platform.follow", "Follow")}
                                                    </button>
                                                </div>
                                            );
                                        })}
                                        {followRecommendations.length === 0 && (
                                            <div className={`text-xs ${palette.textMuted}`}>
                                                {t(
                                                    "home.platform.no_recommendations",
                                                    "No recommendations"
                                                )}
                                            </div>
                                        )}
                                ...
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                    <div>
                                        ...
                                        <div className="mt-1 text-lg font-black">
                                            {t(
                                                "home.platform.login_to_view_feed",
                                                "Log in to view your following feed"
                                            )}
                                        </div>
                                    </div>
                                    <button
