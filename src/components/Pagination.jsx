...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
    ...
    return (
        <nav
            aria-label={t("common.pagination", "分页")}
            className="flex justify-center items-center space-x-2 sm:space-x-3 mt-8 pb-20 md:pb-8"
        >
            <button
                type="button"
            ...
            <div
                className="flex space-x-2 overflow-x-auto max-w-[240px] sm:max-w-none scrollbar-hide"
                aria-label={t("common.page_numbers", "页码")}
            >
