...
const AppDownload = () => {
    ...
    const palette = isDayMode
        ? {
              ...
              hero: "bg-[radial-gradient(circle_at_82%_10%,rgba(236,72,153,0.13),transparent_26%),radial-gradient(circle_at_16%_78%,rgba(99,102,241,0.1),transparent_28%),linear-gradient(135deg,#ffffff_0%,#f8fbff_58%,#fff7fb_100%)]",
        ...
        : {
              ...
              hero: "bg-[radial-gradient(circle_at_82%_10%,rgba(168,85,247,0.24),transparent_25%),radial-gradient(circle_at_16%_78%,rgba(34,211,238,0.14),transparent_28%),linear-gradient(135deg,#05070b_0%,#0a1020_58%,#080710_100%)]",
    ...
    return (
        <>
            <SEO title={t("download.meta_title")} description={t("download.meta_desc")} />
            <section className={`min-h-screen overflow-hidden ${palette.page}`}>
                <div
                    className={`relative flex min-h-screen items-start px-5 pb-24 pt-[calc(env(safe-area-inset-top)+76px)] md:items-center md:pb-16 md:pt-28 ${palette.hero}`}
                >
                    <div className="mx-auto grid w-full max-w-6xl items-center gap-6 md:gap-10 lg:grid-cols-[minmax(0,1fr)_360px]">
                        <motion.div {...reveal(shouldAnimate)}>
                            <p
                                className={`text-xs font-black uppercase tracking-[0.28em] ${palette.label}`}
                            >
                                {t("download.kicker")}
                            </p>
                            ...
                            <p
                                className={`mt-3 max-w-xl text-sm leading-6 md:mt-5 md:text-lg md:leading-7 ${palette.textSoft}`}
                            >
                                {t("download.subtitle")}
                            </p>
                            ...
                            <p
                                className={`mt-3 text-xs leading-5 md:mt-4 md:leading-6 ${palette.textMuted}`}
                            >
