...
export const useAdminTheme = () => {
    ...
    return {
        ...
        iconWrapClass: isDayMode ? "bg-slate-100 text-slate-500" : "bg-white/5 text-gray-500",
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <div className="min-w-0">
                        <h2
                            ...
                            style={
                                isDayMode ? { fontFamily: "var(--theme-font-display)" } : undefined
                            }
                        >
                            {title}
                        </h2>
                ...
                <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div className="min-w-0">
                        ...
                        {description ? (
                            <p
                                className={clsx(
                                    "mt-1 text-xs leading-5 md:text-sm",
                                    mutedTextClass
                                )}
                            >
                                {description}
...
export const ToolbarGroup = ({ children, className }) => (
    <div className={clsx("flex min-w-0 flex-wrap items-center gap-2", className)}>{children}</div>
);
...
export const AdminButton = ({ tone = "default", children, className, ...props }) => {
    const { isDayMode } = useAdminTheme();
    const toneClassName = {
        default: "theme-button-secondary",
        primary: "theme-button-primary",
        success: "border border-transparent bg-emerald-600 text-white hover:bg-emerald-500",
        danger: "border border-transparent bg-rose-600 text-white hover:bg-rose-500",
        subtle: isDayMode
...
export const AdminIconButton = ({ label, tone = "default", children, className, ...props }) => {
    const { isDayMode } = useAdminTheme();
    const toneClassName = {
        default: isDayMode
...
export const ConfirmDialog = ({
    ...
    const { dialogBackdropClass, dialogPanelClass, mutedTextClass, isDayMode } = useAdminTheme();
