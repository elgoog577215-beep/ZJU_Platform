...
import { Edit2, Image as ImageIcon, Plus, RefreshCw, Trash2 } from "lucide-react";
                ...
                <div className="grid gap-4 lg:grid-cols-[360px_minmax(0,1fr)]">
                    <AdminPanel title={editingId ? "编辑分类" : "新建分类"}>
                        <form onSubmit={submitForm} className="space-y-3">
                            <div>
                                <label className={`text-xs font-bold ${mutedTextClass}`}>
                                    分类名称
                                </label>
                                <input
                                    value={form.name}
                                        ...
                                        <tr key={category.id} className="theme-admin-row">
                                            <td className="p-4">
                                                ...
                                                {category.description ? (
                                                    <div
                                                        className={`mt-1 max-w-md text-xs ${mutedTextClass}`}
                                                    >
                                                        {category.description}
                                                    </div>
                                                ) : null}
