...
import { AlertCircle, Home, Loader2, LogIn, LogOut, ShieldCheck } from "lucide-react";
...
const AdminAccessGate = () => {
    ...
    const shellClass = isDayMode ? "theme-admin-shell text-slate-950" : "bg-black text-white";
    ...
    const inputClass = "theme-admin-input rect-field min-h-[44px] px-3 py-2.5 text-sm";
    const buttonClass =
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className={`mt-2 text-sm ${mutedClass}`}>
                        {t(
                            "admin.login.no_permission_desc",
                            "当前账号{{username}}不是管理员账号，请退出后使用管理员账号登录。",
                            {
