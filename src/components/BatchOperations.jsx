...
export const BatchActionBar = ({
    ...
    return (
        ...
        >
            <div
                className="flex items-center gap-2 px-4 py-3 bg-[#0a0a0a]/90 backdrop-blur-xl
            ...
            >
                ...
                <div className="flex items-center gap-3 px-2 border-r border-white/10">
                    <span className="text-white font-medium">已选择 {selectedCount} 项</span>
                    <button
                        onClick={deselectAll}
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className="text-gray-400 text-sm mb-4">输入标签，用逗号分隔</p>
 ...
 */
export const BatchDeleteConfirm = ({
    isOpen,
    onClose,
    onConfirm,
    selectedCount,
