                ...
                {articles.map((article) => (
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3
                                className={`text-xl font-bold mb-2 leading-tight transition-colors line-clamp-2 ${isDayMode ? "text-slate-900 group-hover:text-red-500" : "text-white group-hover:text-red-400"}`}
                            >
                                {article.title}
                            </h3>
                            <p
                                className={`text-sm line-clamp-3 leading-relaxed ${isDayMode ? "text-slate-600" : "text-gray-400"}`}
                            >
                                {article.description}
                            </p>
                        </div>
                        ...
                        <div
                            className={`relative z-10 flex items-center gap-2 text-xs font-bold mt-4 opacity-50 group-hover:opacity-100 transition-opacity ${isDayMode ? "text-slate-700" : "text-white"}`}
                        >
