  ...
  return (
    <div className="h-full flex flex-col">
      ...
      >
        ...
        <div className={`absolute top-3 right-3 rounded-full border p-2 opacity-0 transition-all transform translate-y-2 group-hover:translate-y-0 group-hover:opacity-100 z-10 ${isDayMode ? 'bg-white border-slate-200/80' : 'bg-black/30 border-white/20 backdrop-blur-md'}`}>
