    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center border group-hover:scale-110 transition-transform duration-300 ${isDayMode ? "bg-white border-slate-200/80 text-indigo-600" : "bg-white/10 border-white/20 backdrop-blur-sm"}`}
                >
                    <Play
                        size={24}
                        fill="currentColor"
                        className={`${isDayMode ? "text-indigo-600" : "text-white"} ml-1`}
                    />
                </div>
            </div>
            ...
            <div className="absolute bottom-0 left-0 w-full p-6">
                ...
                <h3
                    className={`text-xl font-bold font-serif leading-tight line-clamp-2 ${isDayMode ? "text-slate-900" : "text-white"}`}
                >
                    {mainVideo.title}
                </h3>
            </div>
