...
import { AtSign, Github, Globe, Link as LinkIcon, Mail, MessageCircle, Video } from "lucide-react";
...
const openSocialLink = async (link) => {
    ...
    const href =
        meta.mail && !String(link.url).startsWith("mailto:") ? `mailto:${link.url}` : link.url;
