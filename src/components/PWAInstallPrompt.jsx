            ...
            {showPrompt && !isStandalone && !isMiniProgramWebView() && (
                ...
                >
                    ...
                    <div className="min-w-0 flex-1">
                        <h4
                            className={`text-sm font-bold leading-tight ${isDayMode ? "text-slate-900" : "text-white"}`}
                        >
                            {t("pwa.install_title")}
                        </h4>
                        <p
                            className={`mt-0.5 text-xs leading-snug ${isDayMode ? "text-slate-500" : "text-gray-400"}`}
                        >
                            {t("pwa.install_desc")}
                        </p>
                    </div>
