        ...
        if (this.state.hasError) {
            ...
            return (
                <div
                    role="alert"
                    aria-live="assertive"
                    className="min-h-screen flex flex-col items-center justify-center bg-black text-white p-6 text-center z-[100] relative"
                >
                    <h1 className="text-4xl font-bold font-serif text-red-500 mb-4">
                        {t("error.something_went_wrong")}
                    </h1>
                    <p className="text-gray-400 max-w-md mb-8">{t("error.boundary_desc")}</p>
                    {this.state.error && (
