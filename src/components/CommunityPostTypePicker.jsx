        ...
        <AnimatePresence>
            {isOpen ? (
                ...
                >
                    ...
                    >
                        <header
                            className={`flex items-start justify-between gap-4 border-b px-5 py-4 md:px-6 ${isDayMode ? "border-slate-200" : "border-white/10"}`}
                        >
                            <div>
                                <p
                                    className={`text-[11px] font-black uppercase tracking-[0.2em] ${isDayMode ? "text-slate-500" : "text-gray-500"}`}
                                >
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span className="min-w-0">
                                                ...
                                                <span
                                                    className={`mt-1 block text-sm leading-5 ${isActive ? "opacity-85" : isDayMode ? "text-slate-500" : "text-gray-400"}`}
                                                >
