      ...
      `}
        ...
        >
            <div className="flex items-stretch">
                ...
                {/* Item Content */}
                <div className="flex-1 p-4">{renderItem(item, index)}</div>
            </div>
        </Reorder.Item>
    );
};
 ...
 */
export const SortablePhotoGrid = ({ photos, onReorder, onPhotoClick, disabled = false }) => {
        ...
        >
            ...
            `}
                    >
                        ...
                        {!disabled && <GripVertical size={18} className="text-gray-500" />}
 ...
 */
export const AlbumOrganizer = ({ albums, unassignedPhotos, onPhotoMove, onAlbumReorder }) => {
                ...
                {albums.map((album) => (
                    ...
                    >
                        ...
                        {album.photos?.length > 0 ? (
                            ...
                            <p className="text-sm text-gray-500 text-center py-8">拖拽照片到此处</p>
                        )}
                    </motion.div>
                ))}
            </div>
