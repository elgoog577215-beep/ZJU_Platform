    ...
    return (
        ...
        >
            <div className="motion-gpu relative h-14 w-14">
                <div
                    className={`absolute inset-0 rounded-full border ${isDayMode ? "border-slate-200/80 bg-white/34 shadow-[0_18px_44px_rgba(100,116,139,0.14)]" : "border-white/10"}`}
                />
                <div
                ...
                />
                <div
                    className={`absolute inset-[42%] rounded-full ${isDayMode ? "bg-slate-900/82" : "bg-white/90"}`}
                />
            </div>

            <p
                className={`mt-4 text-xs font-semibold uppercase ${isDayMode ? "text-slate-500" : "text-white/55"}`}
            >
                {loadingLabel}
            </p>
        </div>
