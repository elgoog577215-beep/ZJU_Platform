...
import { Play, Film, X, Upload, AlertCircle, ArrowRight } from "lucide-react";
    ...
    return (
        <section className="pt-[calc(env(safe-area-inset-top)+76px)] pb-6 md:py-24 px-4 md:px-8 min-h-screen relative z-10 overflow-x-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none z-0 hidden overflow-hidden md:block">
                <div
                    className={`absolute inset-x-0 top-24 h-px ${isDayMode ? "bg-gradient-to-r from-transparent via-slate-200/80 to-transparent" : "bg-white/10"}`}
                />
                <div
                    className={`absolute inset-x-0 top-52 h-px ${isDayMode ? "bg-gradient-to-r from-transparent via-violet-100/60 to-transparent" : "bg-white/10"}`}
                />
                {allowAmbientEffects && (
                    <div
                        className={`absolute left-0 top-0 h-full w-px ${isDayMode ? "bg-slate-200/40" : "bg-white/10"}`}
                    />
                )}
            </div>
                ...
                {createPortal(
                    isMobileSortOpen ? (
                        <>
                            ...
                            >
                                <div
                                    className={`p-4 border-b flex justify-between items-center sticky top-0 z-10 ${isDayMode ? "bg-white/96 border-slate-200/80" : "bg-[#1a1a1a]/95 border-white/10"}`}
                                >
                                    <div>
                                        <h3
                    ...
                    {loading && displayVideos.length === 0 ? (
                        ...
                        <div className="col-span-full flex flex-col items-center justify-center px-4 py-12 md:py-20">
                            <div className="rect-panel mb-4 border border-red-500/20 bg-red-500/10 p-5 md:mb-6 md:p-6">
                                <AlertCircle
                                    size={40}
                                    className="text-red-400 opacity-80 md:h-12 md:w-12"
                                />
                            </div>
                        ...
                        <div className="col-span-full flex flex-col items-center justify-center px-4 py-12 md:py-20">
                            <div className="rect-panel mb-4 border border-white/5 bg-pink-500/10 p-5 md:mb-6 md:p-8">
                                <Film
                                    size={44}
                                    className="text-pink-400 opacity-80 md:h-16 md:w-16"
                                />
                            </div>
                            <h3
