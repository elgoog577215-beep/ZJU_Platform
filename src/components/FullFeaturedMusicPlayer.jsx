        ...
        <div className="h-full flex flex-col bg-[#0a0a0a]/50 backdrop-blur-2xl border border-white/20 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="p-6 relative overflow-hidden flex-shrink-0">
                ...
                <div className="relative z-10 flex flex-col items-center pt-4">
                    ...
                    >
                        <SmartImage
                            src={getThumbnailUrl(displayTrack.cover)}
                    ...
                    <div className="flex items-center justify-between w-full px-2">
                        <button
                            ...
                            className="text-[10px] font-bold text-cyan-400 bg-cyan-500/10 px-2 py-1 rounded border border-cyan-500/20 hover:bg-cyan-500/20"
                        >
                            {playbackSpeed}x
                        </button>
                    ...
                    {tracks.map((track, idx) => (
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <div
                                    className={`text-xs font-bold truncate ${currentTrack?.id === track.id ? "text-cyan-400" : "text-white"}`}
                                >
                                    {track.title}
                                </div>
