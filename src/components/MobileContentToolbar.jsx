...
const MobileContentToolbar = ({
    ...
    return (
        <div
            className={`mb-3 grid w-full ${showClearAction ? "grid-cols-[1fr_1fr_0.98fr]" : "grid-cols-2"} gap-2 md:hidden`}
        >
            <motion.button
                {...motionProps}
                type="button"
            ...
            >
                ...
                {filterCount > 0 ? (
                    <span
                        className={`inline-flex h-5 min-w-5 items-center justify-center rounded-full px-1 text-[11px] leading-none text-white ${
