...
const apiBaseURL =
    import.meta.env.VITE_API_BASE_URL || (isNativeCapacitor ? "https://tuotuzju.com/api" : "/api");
...
export const getProfileCard = (userId, config = {}) =>
    api.get(`/users/${userId}/profile-card`, config);
