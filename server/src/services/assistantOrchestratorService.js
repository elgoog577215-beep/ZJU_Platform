...
const buildMessages = ({ systemPrompt, payload, outputContract, userPrompt }) => [
    {
        role: "system",
        content: [
        ...
        content: JSON.stringify(
            {
                ...
                instruction:
                    userPrompt ||
                    "Reason over the provided context and return the requested JSON contract.",
            },
            null,
            2
        ),
