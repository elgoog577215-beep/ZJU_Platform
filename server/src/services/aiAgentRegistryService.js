...
const AGENT_DEFINITIONS = [
  ...
  },
  {
    ...
    promptTemplates: [
      {
        ...
        version: 'v1-rule',
        purpose: 'Map query terms to modules, event categories, campuses, audiences, benefits, media type, and time range without model dependency.',
      },
    ],
    reasoningChain: [
    ...
    qualityBacklog: {
      ...
      auto_update: 'Regenerate search guidance when searchable modules or index schemas change.',
    },
    maturity: {
