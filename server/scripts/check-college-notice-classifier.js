const { normalizeCollegeNoticeFields } = require("../src/services/eventIntelligenceService");
...
const main = () => {
    ...
    assert(
        evaluationNotice.source_college === "计算机科学与技术学院",
        "Expected CS college source."
    );
    ...
    assert(
        normalEvent.is_college_notice === 0,
        "Expected normal event not to be a college notice."
    );
