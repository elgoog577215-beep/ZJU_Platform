...
- 夜间采用原站深夜蓝与中性灰：复用活动聚合的 `ecosystem-landscape-shell` 夜景背景，表面 `rgba(15, 23, 42, 0.9)`、悬停 `#1e293b`、正文 `#f1f5f9`、辅助文字 `#b3c0d3`，焦点和选中强调为靛蓝 `#a5b4fc`，边界为低透明度白色。背景图与遮罩由公共样式统一提供，白天不启用该背景。
