...
### 7. 首屏用四股真实支持力量形成支持网络图

名录页首屏把校内、企业、资本、组织四股支持力量与真实总量组成可点击网络。企业节点显示技术企业和行业企业的合计数量；中心节点返回全部支持方。视觉进一步放大总量、四个分组名称和连接结构，用 About 已有的巨大字、冷色线条与高对比表面形成首屏峰值，不增加新颜色或虚构合作关系。移动端保持四分组顺序与完整可操作性。
...
- [网络图被误读为具体合作关系图] → 连线只从校内、企业、资本、组织四个分组汇聚到“全部支持方”中心，不绘制支持方之间的关系，也不展示未经确认的强弱、层级或流向。
