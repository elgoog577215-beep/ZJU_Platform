# admin-access-controls Specification

## Purpose

Provide a shared administrator console with configurable operational access, immediate revocation, audited grants and separate protection for private accounts and system administration.
