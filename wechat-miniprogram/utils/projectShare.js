...
const titleInitials = (value) => String(value || COPY.fallbackTitle).trim().slice(0, 2) || "项目";
...
const normalizeProject = (raw = {}, fallback = {}) => {
  ...
  const ownerName = project.owner_name || project.ownerName || project.author_name || project.authorName || project.owner || COPY.anonymousOwner;
